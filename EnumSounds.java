...
public class EnumSounds {
        ...
        public static void playSound(Location l, ListEnumSounds sounds, float volumen, float tono) {
            try {
                l.getWorld().playSound(l, sounds.get(), volumen, tono);
            } catch (Exception exception) {

            }
        }

        public static void playSound(Player p, Location l, ListEnumSounds sounds, float volumen, float tono) {
            try {
                p.playSound(l, sounds.get(), volumen, tono);
            } catch (Exception exception) {}
        }

        public enum ListEnumSounds {
            ...
            ListEnumSounds(String on, String nn) {
                this.on = on;
                this.nn = nn;
            }

            public Sound get() {
                return Bukkit.getVersion().contains("1.8") ? Sound.valueOf(this.on) : Sound.valueOf(this.nn);
            }
        }
    }
